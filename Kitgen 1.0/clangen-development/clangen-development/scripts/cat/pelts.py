...
class Pelt():
    ...
    def init_sprite(self):
        self.cat_sprites = {
            ...
            'adolescent': random.randint(0, 2),
            'senior': random.randint(0, 2),
            'sick_young': 19,
            'sick_adult': 19,
        }
        ...
        if self.length != 'long':
            self.cat_sprites['adult'] = random.randint(0, 2)
            self.cat_sprites['para_adult'] = 2
        else:
            self.cat_sprites['adult'] = random.randint(0, 2)
            self.cat_sprites['para_adult'] = 0
        self.cat_sprites['young adult'] = self.cat_sprites['kitten']
        self.cat_sprites['senior adult'] = self.cat_sprites['kitten']
